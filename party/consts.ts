...
export const ANIMATION_DURATIONS = {
  ...
  matchupReveal: {
    total: 2500,        // Total time before showing betting UI
  ...
  results: {
    total: 2000,           // Time before "Next round" message
  ...
  potSummary: {
    staggerDelay: 100,  // Delay between each matchup (multiplied by index)
  },
